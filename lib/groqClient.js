        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: "Describe this image as if you were a sports commentator for a Warriors game. Make sure to note the number of players in the key, in the 3pt line, and outside the 3pt line.",
              },
              {
                type: "image_url",
                image_url: {
